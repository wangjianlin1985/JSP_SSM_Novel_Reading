...
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES ('12190901190924667', '西游记', '吴承恩', '西游记，大家都知道。', '12', '1', '2019-09-01', '/usr/local/tomcat/webapps/ssm_ebooknet/ebooks/经典文学/古典文学/西游记.pdf', '/usr/local/tomcat/webapps/ssm_ebooknet/ebooks/bookCovers/经典文学/古典文学/西游记.jpg', 'pdf');
INSERT INTO `book` VALUES ('22190901190924369', '怎么样都喜欢', '砂梨', '怎么样都喜欢', '22', '1', '2019-09-01', '/usr/local/tomcat/webapps/ssm_ebooknet/ebooks/通俗小说/青春言情/怎么样都喜欢.txt', '/usr/local/tomcat/webapps/ssm_ebooknet/ebooks/bookCovers/通俗小说/青春言情/怎么样都喜欢.jpg', 'txt');
INSERT INTO `book` VALUES ('31190901190924165', 'JAVA开发手册', '阿里巴巴', '阿里巴巴出品的一个JAVA开发手册', '31', '9', '2019-09-01', '/usr/local/tomcat/webapps/ssm_ebooknet/ebooks/计算机类/编程语言/JAVA开发手册.pdf', '/usr/local/tomcat/webapps/ssm_ebooknet/ebooks/bookCovers/计算机类/编程语言/JAVA开发手册.jpg', 'pdf');
INSERT INTO `book` VALUES ('45190901190924380', '故事会', '故事会出品', '故事会，一本故事杂志', '45', '0', '2019-09-01', '/usr/local/tomcat/webapps/ssm_ebooknet/ebooks/杂志期刊/娱乐休闲/故事会.pdf', '/usr/local/tomcat/webapps/ssm_ebooknet/ebooks/bookCovers/杂志期刊/娱乐休闲/故事会.jpg', 'pdf');
...
INSERT INTO `feedback` VALUES ('2', '2', '1347845688', '这个网站不错，好评一个。', '0', '2019-09-24 10:58:14');
...
INSERT INTO `user` VALUES ('2', 'user1', '123456', '张熙桐', '1347845688@qq.com', '1', '14', '2019-09-24');
