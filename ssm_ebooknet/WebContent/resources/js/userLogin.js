$(document).ready(function () {
    function e(e) {
        $("#loginHead").addClass("hide"), $("#userHead").removeClass("hide"), $("#navbar #loginedInfo a").popover({
            ...
            }), $("#userName").text(" " + e.user.userName), $("#contribution").text(e.user.contributionValue), $("#levelImg").attr("src", "/ssm_ebooknet/"+e.user.contribution.level_img), $("#levelImg").attr("alt", e.user.contribution.level_txt), $("#toPersonInfo").on({
                click: function () {
